...
const doorAphaTexture = textureLoader.load('/textures/door/alpha.jpg')
...
const roofTextureColor = textureLoader.load('/textures/roof/color.jpg')
const roofAmbientOcclusionTexture = textureLoader.load('/textures/roof/ambientOcclusion.jpg')
const roofHeightTexture = textureLoader.load('/textures/roof/displacement.jpg')
...
const grassNormalTexture = textureLoader.load('/textures/grass/normal.png')
const grassRoughnessTexture = textureLoader.load('/textures/grass/roughness.png')
...
const graveColorTexture =  textureLoader.load('/textures/grave/color.png')
const graveHeightTexture =  textureLoader.load('/textures/grave/displacement.png')
const graveRoughnessTexture =  textureLoader.load('/textures/grave/rough.png')
const graveAmbientOcclusionTexture =  textureLoader.load('/textures/grave/ao.png')
...
const door = new THREE.Mesh(
    new THREE.PlaneBufferGeometry(1,1.5, 200, 200),
    new THREE.MeshStandardMaterial({
 ...
 */
// Ambient light
const ambientLight = new THREE.AmbientLight('#b9d5ff', 0.366)
gui.add(ambientLight, 'intensity').min(0).max(1).step(0.001)
scene.add(ambientLight)

// Directional light
const moonLight = new THREE.DirectionalLight('#b9d5ff', 1)
moonLight.position.set(-1.227, 3, -2.202)
